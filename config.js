...
global.sudo = process.env.SUDO || '967778088098'
global.devs = '967778088098';
...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? '*𝐒𝐇𝐀𝐃𝐎𝐖*' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? '𝐒𝐇𝐀𝐃𝐎𝐖' : process.env.OWNER_NAME,
  sessionName:  process.env.SESSION_ID === undefined ? false : process.env.SESSION_ID,
  author:  process.env.PACK_INFO.split(";")[0] === undefined ? '*『𝐒𝐇𝐀𝐃𝐎𝐖』*' : process.env.PACK_INFO.split(";")[0],
  auto_read_status :  process.env.AUTO_READ_STATUS === undefined ? false : process.env.AUTO_READ_STATUS,
  packname:  process.env.PACK_INFO.split(";")[1] === undefined ? '𝐒𝐇𝐀𝐃𝐎𝐖' : process.env.PACK_INFO.split(";")[1],
